...
const CreateUser = () => {
    ...
    const handleSubmit = (e: React.SyntheticEvent<HTMLFormElement>) => {
        ...
        axios.post("http://thelowerorbit.com:8080/api/account/register", {
                            ...
                            <Card.Body>
                                <Form className="text-left" onSubmit={handleSubmit}>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="text" id="firstname" onChange={onFieldChange} required />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Last Name</Form.Label>
                                        <Form.Control type="text" id="lastname" onChange={onFieldChange} required />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Phone Number</Form.Label>
                                        <Form.Control type="tel" id="phone" pattern="[0-9]{10}" onChange={onFieldChange} required />
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="email" id="email" onChange={onFieldChange} required />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                        <Form.Label>Password</Form.Label>
                                        <Form.Control type="password" id="password" onChange={onFieldChange} required />
                                    </Form.Group>
